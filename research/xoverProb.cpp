...
int ingredients[MAX_WEAPONS][5] = {        
        ...
        { KW_NONE, KW_NONE, KW_NONE, KW_NONE, KW_NONE }, // Top
        ...
        //MM4
        { KW_BOMB, KW_NONE, KW_NONE, KW_NONE, KW_NONE }, // Drill // TARGETER
        ...
        { KW_NONE, KW_NONE, KW_NONE, KW_NONE, KW_NONE }, // Charge
        ...
        { KW_BOOMERANG, KW_NONE, KW_NONE, KW_NONE, KW_NONE }, // Knight // melee/bouncy/cutter
        ...
        { KW_CUTTER, KW_NONE, KW_NONE, KW_NONE, KW_NONE }, // Slash // KW_NATURE
        ...
        //MMB
        { KW_WIND, KW_MELEE, KW_CUTTER, KW_NONE, KW_NONE }, // TenguB // BOUNCY:CHARGEABLE
        ...
        { KW_CUTTER, KW_CRAWLER, KW_MELEE, KW_NONE, KW_NONE }, // Nitro // KW_MELEE
        ...
        { KW_CHARGEABLE, KW_NONE, KW_NONE, KW_NONE, KW_NONE }, // Pluto
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "\ntotal " << count << " which is " << ((double) count /(double) ((MAX_WEAPONS*(MAX_WEAPONS-1))/2))*100.0 << "%";
